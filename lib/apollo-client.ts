...
const possibleTypesConfig = {
  possibleTypes: {
    TermInterface: ['TermConservationStatus', 'TermEventType', 'TermNewsCategory', 'TermProjectArea', 'TermTag'],
    NodeInterface: ['NodeHomepage', 'NodeProject', 'NodeSpecies', 'NodeEvent', 'NodeNews', 'NodePage'],
