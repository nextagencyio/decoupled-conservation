...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!item) {
    return { title: 'Project Not Found | Conservation' }
  }
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-xl shadow-sm p-6 sticky top-24">
                ...
                <dl className="space-y-4">
                  ...
                  {(item as any).fundingGoal && (
                    <div>
                      <dt className="text-sm text-gray-500">Funding Goal</dt>
                      <dd className="font-semibold text-gray-900">{(item as any).fundingGoal}</dd>
                    </div>
                  )}
                </dl>
                <div className="mt-8">
