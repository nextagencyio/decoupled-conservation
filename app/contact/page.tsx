...
export const metadata: Metadata = {
  title: 'Contact Us',
  description: 'Contact Pacific Coast Conservation Alliance. We\'d love to hear from you about conservation programs, volunteer opportunities, or donations.',
  keywords: ['Contact Pacific Coast Conservation Alliance', 'Support', 'Help', 'Get in Touch'],
}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8 md:mb-12">
            ...
            <p className="text-base md:text-lg text-gray-600">
              Have questions about conservation programs, volunteer opportunities, or donations? We&#39;d love to hear from you.
            </p>
          </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@pacificcoastconservation.org</p>
                    <p className="text-gray-600">support@pacificcoastconservation.org</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">(555) 456-7801</p>
